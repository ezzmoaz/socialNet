...
<div class="main_column column">
	...
	<?php
	$user_data_query = mysqli_query($con, "SELECT first_name, last_name, email, about_me, DoB FROM users WHERE email='$userLoggedIn'");
	...
	<form action="settings.php" method="POST">
		...
		DoB: <input type="date" name="DoB" value="<?php echo $DoB; ?>" id="settings_input"><br>
		About Me: <input type="text" name="about_me" value="<?php echo $about_me; ?>" id="settings_input"><br>
		 	<input type="hidden"  name="email" value="<?php echo $email; ?>" id="settings_input"><br>
