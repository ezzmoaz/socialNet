...
class Notification {
	...
	public function __construct($con, $userEmail){
		$this->con = $con;
		$this->user_obj = new User($con, $userEmail);
	}
	...
	public function getNotifications($data, $limit) {
		...
		while($row = mysqli_fetch_array($query)) {
			...
			$user_data_query = mysqli_query($this->con, "SELECT * FROM users WHERE email='$user_from'");
